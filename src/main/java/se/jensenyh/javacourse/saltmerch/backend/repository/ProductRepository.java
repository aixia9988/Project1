...
public class ProductRepository
{
    ...
    public List<Product> selectAll(String category)
    {
        ...
        if (category != null) sql += " WHERE category = ?";
        ...
        if ( category != null )
            products = jdbcTemplate.query(sql, rm, category);
        else
            products = jdbcTemplate.query(sql, rm);
        return products;
    }
    ...
    public int deleteVariant(int productId, String color)
    {
        ...
        var sql = "Delete a variant row from variants";// <<<< todo: WRITE SQL QUERY HERE
